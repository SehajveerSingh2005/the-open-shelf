      ...
      >
        <header className="mb-24 space-y-10">
          <div className="space-y-6">
            <p className={cn("text-[10px] uppercase tracking-[0.5em] font-sans font-bold", settings.theme === 'light' ? 'text-gray-400' : 'text-gray-600')}>{article.source} • {article.publishedAt}</p>
