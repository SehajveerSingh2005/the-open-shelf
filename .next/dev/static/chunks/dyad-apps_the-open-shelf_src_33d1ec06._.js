...
const ArticleCard = /*#__PURE__*/ _s(__TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$4_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].memo(_c = _s(({ article, onClick, isCanvas = false })=>{
    _s();
...
var _c, _c1;
__turbopack_context__.k.register(_c, "ArticleCard$React.memo");
__turbopack_context__.k.register(_c1, "ArticleCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/dyad-apps/the-open-shelf/src/pages/Profile.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Profile = ()=>{
    _s();
    const { user, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const fetchStacks = async ()=>{
        ...
        setLoading(true);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('stacks').select('*').eq('user_id', user.id).order('created_at', {
                ascending: false
            });
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])("Could not load your stacks.");
        } finally{
            setLoading(false);
        }
    };
    const fetchSavedArticles = async ()=>{
        ...
        setLoading(true);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('saved_articles').select(`
          *,
          articles:articles (*)
        `).eq('stack_id', selectedStack).order('created_at', {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])("Could not load saved articles.");
        } finally{
            setLoading(false);
        }
    };
    ...
    const handleCreateStack = async (e)=>{
        ...
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('stacks').insert({
            ...
            setNewStackName('');
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showSuccess"])("Stack created");
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])("Could not create stack.");
        } finally{
    ...
    const handleDeleteStack = async (stackId)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('stacks').delete().eq('id', stackId);
            if (error) throw error;
            setStacks((prev)=>prev.filter((s)=>s.id !== stackId));
            if (selectedStack === stackId) {
                setSelectedStack(stacks.length > 1 ? stacks[1].id : null);
            }
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showSuccess"])("Stack removed");
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$dyad$2d$apps$2f$the$2d$open$2d$shelf$2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showError"])("Could not remove stack.");
        }
    };
...
_s(Profile, "ZR6tqA4/QS9rG8LZNwFW9OLqP2E=", false, function() {
    return [
...
//# sourceMappingURL=dyad-apps_the-open-shelf_src_33d1ec06._.js.map